...
void SetupDraw(GpuFixture& fixture, const Surface& surface, uint32_t width, uint32_t height,
...
void DrawRectFloat(GpuFixture& fixture, uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1, float r,
...
void DrawRect(GpuFixture& fixture, uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1,
              uint32_t color) {
