...
| [xenia-canary/xenia-canary #1111](https://github.com/xenia-canary/xenia-canary/pull/1111) | open PR | `78e06cafaa6429e5464786baa9e1edf252bbe582` | C/H; relevant but pending upstream; experimental | See scoped record below; never assume absence | RG-GDK-010 |
...
| [xenia-canary/xenia-canary #1058](https://github.com/xenia-canary/xenia-canary/pull/1058) | merged | `d55670e40b1016cc36cca5111c821b3e7c9a85b8` | B/H; regression-related | See scoped record below; never assume absence | RG-GDK-010 |
...
| [has207/xenia-edge #143](https://github.com/has207/xenia-edge/pull/143) | merged | `c9a6327ad136f82920df547afc9e552424b863ac` | G/H; useful research; obsolete workaround | See scoped record below; never assume absence | RG-GDK-010 |
...
- Upstream status: **pending upstream**. PR head (not adopted) commit `78e06cafaa6429e5464786baa9e1edf252bbe582`.
- Scope / reason / applicability: WIP VIZ predication changes query lifecycle, host predicates and ROV counters; local visibility is currently faked.
- Classification: relevant but pending upstream; experimental; C/H applicability. No adoption by this documentation change.
- Adaptation and validation owner: **RG-GDK-010**, whose complete issue body specifies files, tests and acceptance gates.
- Source files: `src/xenia/gpu/command_processor.cc`; `src/xenia/gpu/command_processor.h`; `src/xenia/gpu/d3d12/d3d12_command_processor.cc`; `src/xenia/gpu/d3d12/d3d12_command_processor.h`; `src/xenia/gpu/d3d12/d3d12_query_pool.cc`; `src/xenia/gpu/d3d12/d3d12_query_pool.h`; `src/xenia/gpu/d3d12/deferred_command_list.cc`; `src/xenia/gpu/d3d12/deferred_command_list.h`; `src/xenia/gpu/d3d12/pipeline_cache.cc`; `src/xenia/gpu/d3d12/pipeline_cache.h`; `src/xenia/gpu/draw_util.cc`; `src/xenia/gpu/draw_util.h`; `src/xenia/gpu/dxbc_shader_translator.cc`; `src/xenia/gpu/dxbc_shader_translator.h`; `src/xenia/gpu/dxbc_shader_translator_om.cc`; `src/xenia/gpu/gpu_flags.h`; `src/xenia/gpu/pm4_command_processor_implement.h`; `src/xenia/gpu/spirv_shader_translator.cc`; `src/xenia/gpu/spirv_shader_translator.h`; `src/xenia/gpu/spirv_shader_translator_rb.cc`; `src/xenia/gpu/vulkan/deferred_command_buffer.cc`; `src/xenia/gpu/vulkan/deferred_command_buffer.h`; `src/xenia/gpu/vulkan/vulkan_command_processor.cc`; `src/xenia/gpu/vulkan/vulkan_command_processor.h`; `src/xenia/gpu/vulkan/vulkan_pipeline_cache.cc`; `src/xenia/gpu/vulkan/vulkan_pipeline_cache.h`; `src/xenia/gpu/vulkan/vulkan_query_pool.cc`; `src/xenia/gpu/vulkan/vulkan_query_pool.h`; `src/xenia/ui/vulkan/functions/device_ext_conditional_rendering.inc`; `src/xenia/ui/vulkan/vulkan_device.cc`; `src/xenia/ui/vulkan/vulkan_device.h`.
- Regression evidence: Known hazard or regression is described above and in the linked discussion; reproduce independently.
...
- Source: [https://github.com/xenia-canary/xenia-canary/pull/1218](https://github.com/xenia-canary/xenia-canary/pull/1218); created 2026-09-07T04:36:41Z; updated 2026-09-20T16:14:06Z; author `goldislead`.
- Upstream status: **merged upstream**. Merge commit `3d233a5b2e94b940825847b70c788951e364bb33`.
- Scope / reason / applicability: Running sample counters/QueryBatch; Crackdown 2 comments describe fast OQ/readback lens-flare interaction.
...
- Adaptation and validation owner: **RG-GDK-010**, whose complete issue body specifies files, tests and acceptance gates.
- Source files: `src/xenia/gpu/command_processor.cc`; `src/xenia/gpu/command_processor.h`; `src/xenia/gpu/d3d12/d3d12_command_processor.cc`; `src/xenia/gpu/d3d12/d3d12_command_processor.h`; `src/xenia/gpu/d3d12/d3d12_zpd_query_pool.cc`; `src/xenia/gpu/d3d12/d3d12_zpd_query_pool.h`; `src/xenia/gpu/d3d12/pipeline_cache.cc`; `src/xenia/gpu/d3d12/pipeline_cache.h`; `src/xenia/gpu/dxbc_shader_translator.cc`; `src/xenia/gpu/dxbc_shader_translator.h`; `src/xenia/gpu/dxbc_shader_translator_om.cc`; `src/xenia/gpu/gpu_flags.cc`; `src/xenia/gpu/gpu_flags.h`; `src/xenia/gpu/pm4_command_processor_implement.h`; `src/xenia/gpu/spirv_shader_translator.cc`; `src/xenia/gpu/spirv_shader_translator.h`; `src/xenia/gpu/spirv_shader_translator_rb.cc`; `src/xenia/gpu/vulkan/vulkan_command_processor.cc`; `src/xenia/gpu/vulkan/vulkan_command_processor.h`; `src/xenia/gpu/vulkan/vulkan_pipeline_cache.cc`; `src/xenia/gpu/vulkan/vulkan_pipeline_cache.h`; `src/xenia/gpu/vulkan/vulkan_zpd_query_pool.cc`; `src/xenia/gpu/vulkan/vulkan_zpd_query_pool.h`; `src/xenia/gpu/xenos.h`; `src/xenia/gpu/xenos_zpd_report.h`.
- Regression evidence: Unknown/not established for ReXGlue. Run the issue-specific regression suite and relevant vendor cases.
...
- Classification: useful research; obsolete workaround; G/H applicability. No adoption by this documentation change.
- Adaptation and validation owner: **RG-GDK-010**, whose complete issue body specifies files, tests and acceptance gates.
